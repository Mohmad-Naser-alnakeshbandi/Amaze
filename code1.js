...
gdjs.GameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(12841556);
}
}}
...
{gdjs.evtsExt__CameraShake__ShakeCamera.func(runtimeScene, 2, 1, 1, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
    ...
    gdjs.GameCode.GDPlayerObjects2[i].returnVariable(gdjs.GameCode.GDPlayerObjects2[i].getVariables().getFromIndex(0)).sub(0.1);
}
...
{
{gdjs.GameCode.conditionTrue_1 = gdjs.GameCode.condition1IsTrue_0;
gdjs.GameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(12843468);
}
}}
if (gdjs.GameCode.condition1IsTrue_0.val) {
...
{gdjs.evtsExt__CameraShake__ShakeCamera.func(runtimeScene, 2, 1, 1, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
    ...
    gdjs.GameCode.GDPlayerObjects1[i].returnVariable(gdjs.GameCode.GDPlayerObjects1[i].getVariables().getFromIndex(0)).sub(0.1);
}
...
gdjs.copyArray(runtimeScene.getObjects("HealthBar"), gdjs.GameCode.GDHealthBarObjects1);
gdjs.copyArray(runtimeScene.getObjects("HealthBarBox"), gdjs.GameCode.GDHealthBarBoxObjects1);
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.GameCode.GDPlayerObjects1);
...
gdjs.copyArray(runtimeScene.getObjects("water"), gdjs.GameCode.GDwaterObjects1);
{gdjs.evtsExt__WithThreeJS__Create3DScene.func(runtimeScene, 50, "0;0;0", "", "", 1, 1000, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}{for(var i = 0, len = gdjs.GameCode.GDPlayerObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDPlayerObjects1[i].setAngle(90);
}
}{for(var i = 0, len = gdjs.GameCode.GDPlayerObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDPlayerObjects1[i].setZOrder(32);
}
}{for(var i = 0, len = gdjs.GameCode.GDwallsObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDwallsObjects1[i].setZOrder(32);
}
}{for(var i = 0, len = gdjs.GameCode.GDGroundObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDGroundObjects1[i].setZOrder(0);
}
}{for(var i = 0, len = gdjs.GameCode.GDlavaObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDlavaObjects1[i].setZOrder(1);
}
}{for(var i = 0, len = gdjs.GameCode.GDwaterObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDwaterObjects1[i].setZOrder(1);
}
}{for(var i = 0, len = gdjs.GameCode.GDCursorObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDCursorObjects1[i].hide();
}
}{gdjs.evtTools.window.setFullScreen(runtimeScene, true, true);
}{for(var i = 0, len = gdjs.GameCode.GDHealthBarBoxObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDHealthBarBoxObjects1[i].setWidth(200);
}
}{for(var i = 0, len = gdjs.GameCode.GDHealthBarObjects1.length ;i < len;++i) {
    gdjs.GameCode.GDHealthBarObjects1[i].setWidth(180);
}
}{gdjs.evtTools.sound.playSound(runtimeScene, "5ce5d54982dfbcfc01a4bc2887f9ebab34545689cde2fbd2b8d90219a8528d25_Dark Hallway.aac", true, 70, 1);
